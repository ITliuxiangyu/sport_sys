...
/**
 * Servlet implementation class GetZuByPerson
 */
@WebServlet("/GetZuByPerson")
public class GetZuByPerson extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetZuByPerson() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        {  
            ...
            String sql="select * from tiyu_lunwen.t_zu_log where user_id = '" + user_id + "'";  
